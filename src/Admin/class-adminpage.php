...
final class AdminPage {
	...
	public function render(): void {
		...
		<div class="wrap ai-transparency-admin">
			...
			<p><em><?php echo esc_html__( 'Registry data stays in this WordPress site and is not sent to any external service automatically.', 'kairoseth-ai-transparency' ); ?></em></p>
			...
			<?php else : ?>
				<div
					...
					role="region"
					aria-label="<?php echo esc_attr__( 'AI Systems Registry', 'kairoseth-ai-transparency' ); ?>"
					tabindex="0"
				>
					<table class="widefat striped">
						<caption class="screen-reader-text"><?php echo esc_html__( 'AI Systems Registry', 'kairoseth-ai-transparency' ); ?></caption>
						<thead>
							<tr>
			...
			<table class="form-table" role="presentation">
				...
				<tr>
					...
					<td>
						...
						<p class="description" id="kat-interaction-context-description"><?php echo esc_html__( 'Describe where or how visitors, staff or customers interact with this AI system.', 'kairoseth-ai-transparency' ); ?></p>
					</td>
				</tr>
				<tr>
