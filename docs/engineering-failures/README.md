...
- [`2026-09-10-phase8-stale-release-version-assertion.md`](2026-09-10-phase8-stale-release-version-assertion.md) — the intentional 1.0.0 release bump exposed a stale Phase 6 E2E assertion that still expected the development version `0.1.0` even though runtime correctly emitted `1.0.0`.
...
- [`2026-09-10-phase8-stale-release-version-assertion.md`](2026-09-10-phase8-stale-release-version-assertion.md) — el cambio intencional a 1.0.0 reveló un assertion E2E heredado que aún esperaba la versión de desarrollo `0.1.0` aunque runtime devolvía correctamente `1.0.0`.
